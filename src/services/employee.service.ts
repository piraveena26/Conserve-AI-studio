...
export class EmployeeService {
  private readonly _employees = signal<Employee[]>([
     { 
      ...
      designation: 'Assistant Manager', department: 'KSA-Administration - Conserve Solutions', status: 'Resigned', 
      avatar: 'https://i.imgur.com/nV8xlb8.png',
      ...
      identification: { nationalId: '123456789', passport: 'AB123456' },
    ...
    { id: 'EMP002', name: 'Venkatesh S', email: 'venkatesh.s@example.com', employeeId: 'JS002', designation: 'Product Manager', department: 'Product', status: 'Active', avatar: 'https://picsum.photos/id/1011/200/200', firstName: 'Venkatesh', lastName: 'S', skills: [], personalDetails: { dateOfBirth: '1990-01-01', dobOriginal: '1990-01-01', maritalStatus: 'Married', permanentAddress: '', fatherOrSpouseName: '', bloodGroup: '', residentialAddress: '', emergencyContactNumber: '', relation: '', contactNumber: ''}, education: [], experience: [], references: [], identification: {nationalId: '', passport: ''}, compensation: { basicSalary: 0, hra: 0, otherAllowances: 0, ctc: 0, costPerHour: 0 }, bankDetails: {bankName: '', branchName: '', accountNumber: '', ifscCode: ''}, organization: '', orgDateOfJoining: '2019-01-01', ksaEmploymentJoining: '2021-01-01', category: 'C3', reportingTo: '', phoneNumber: '', nationality: 'Indian', employmentType: 'Full-time', gender: 'Male', personalEmail: '', countryCode: '+91', alternateContact: ''},
    { id: 'EMP003', name: 'Susan Wilson', email: 'susan.wilson@example.com', employeeId: 'SW003', designation: 'UX Designer', department: 'Design', status: 'Terminated', avatar: 'https://picsum.photos/id/1027/200/200', firstName: 'Susan', lastName: 'Wilson', skills: [], personalDetails: { dateOfBirth: '', dobOriginal: '', maritalStatus: 'Single', permanentAddress: '', fatherOrSpouseName: '', bloodGroup: '', residentialAddress: '', emergencyContactNumber: '', relation: '', contactNumber: ''}, education: [], experience: [], references: [], identification: {nationalId: '', passport: ''}, compensation: { basicSalary: 0, hra: 0, otherAllowances: 0, ctc: 0, costPerHour: 0 }, bankDetails: {bankName: '', branchName: '', accountNumber: '', ifscCode: ''}, organization: '', orgDateOfJoining: '', ksaEmploymentJoining: '', category: '', reportingTo: '', phoneNumber: '', nationality: '', employmentType: 'Full-time', gender: 'Female', personalEmail: '', countryCode: '+1', alternateContact: ''},
    { id: 'EMP004', name: 'Allyce Brown', email: 'allyce.brown@example.com', employeeId: 'AB004', designation: 'Data Scientist', department: 'Analytics', status: 'Resigned', avatar: 'https://picsum.photos/id/3/200/200', firstName: 'Allyce', lastName: 'Brown', skills: [], personalDetails: { dateOfBirth: '', dobOriginal: '', maritalStatus: 'Single', permanentAddress: '', fatherOrSpouseName: '', bloodGroup: '', residentialAddress: '', emergencyContactNumber: '', relation: '', contactNumber: ''}, education: [], experience: [], references: [], identification: {nationalId: '', passport: ''}, compensation: { basicSalary: 0, hra: 0, otherAllowances: 0, ctc: 0, costPerHour: 0 }, bankDetails: {bankName: '', branchName: '', accountNumber: '', ifscCode: ''}, organization: '', orgDateOfJoining: '', ksaEmploymentJoining: '', category: '', reportingTo: '', phoneNumber: '', nationality: '', employmentType: 'Full-time', gender: 'Female', personalEmail: '', countryCode: '+44', alternateContact: ''},
  ]);
