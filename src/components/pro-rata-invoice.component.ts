...
@Component({
  selector: 'app-pro-rata-invoice',
  template: `
    <div class="space-y-6">
      <div class="bg-white rounded-lg shadow-sm p-4">
        <h1 class="text-2xl font-bold text-slate-800">Pro-rata Invoice</h1>
      </div>
...
export class ProRataInvoiceComponent {
  ...
  // Data
  private allInvoices = this.invoiceService.proRataInvoices;
