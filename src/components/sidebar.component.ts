  ...
  template: `
    <aside class="w-64 bg-white/70 backdrop-blur-xl text-gray-800 flex-shrink-0 flex flex-col border-r border-white/30">
      ...
      <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
        ...
        <div>
          <button (click)="toggleMenu('system')" [class]="getButtonClass('company_creation') || getButtonClass('location_creation') || getButtonClass('system_configuration')">
             <span class="flex items-center">
               <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-3 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          ...
          @if(openMenus().has('system')) {
            <div class="mt-2 space-y-1 pl-9">
              <a href="#" (click)="changeView('company_creation', $event)" [class]="getLinkClass('company_creation')">Company Creation</a>
              <a href="#" (click)="changeView('location_creation', $event)" [class]="getLinkClass('location_creation')">Location Creation</a>
              <a href="#" (click)="changeView('system_configuration', $event)" [class]="getLinkClass('system_configuration')">Configuration</a>
            </div>
          }
        </div>
